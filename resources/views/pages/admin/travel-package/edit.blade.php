...
@push('addon-style')
    <link rel="stylesheet" href="{{ url('plugin/summernote/summernote-bs4.css') }}">
@endpush
            ...
            <div class="card-body">
                <form action="{{ route('travel-package.update', $item->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about" rows="10" class="textarea h-75" id="about">{{ $item->about }}</textarea>
                    </div>
                    <div class="form-group">
...
@push('addon-script')
    <script src="{{ url('plugin/summernote/summernote-bs4.min.js') }}"></script>
    <script>
       $('.textarea').summernote();
    </script>
@endpush
