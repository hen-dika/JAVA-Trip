...
@section('title','JAVA-Trip|Detail')

@push('addon-style')
    <link rel="stylesheet" href="{{ url('vendor/xzoom/dist/xzoom.css') }}" />
@endpush
                    ...
                    <div class="card card-details">
                        ...
                        <div class="gallery">
                            ...
                            <div class="xzoom-container">
                                <img src="{{ Storage::url($item->gallery->first()->image) }}" class="xzoom" id="xzoom-default" xoriginal="{{ Storage::url($item->gallery->first()->image) }}"/>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card card-details card-right">
                        ...
                        <div class="members my-2">
                            <img src="images/members.png" alt="" class="w-75" />
                        </div>
                        <hr />
                    ...
                    <div class="join-container">
                        ...
                        @endauth
                        @guest
                        <a href="{{ route('login') }}" class="btn btn-block btn-join-now mt-3 py-2">Join Now</a>
                        @endguest
                    </div>
                </div>
            </div>
...
@push('addon-script')
    <script src="{{ url('plugin/xzoom/dist/xzoom.min.js') }}"></script>
    <script>
